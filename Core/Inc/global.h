...
extern float D0; // коэффициент смещения для ADC0, ADCR
extern float k0; // коэффициент масштаба для ADC0, ADCR
extern float D1;
extern float k1;

static uint16_t V0[2], A0[2];
static uint8_t  n0 = 0;

static uint16_t V1_[2], A1_[2];
static uint8_t  n1 = 0;
